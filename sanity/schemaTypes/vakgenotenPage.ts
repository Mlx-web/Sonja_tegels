...
const cardField = defineField({
  ...
  description:
    'Voeg toe, verwijder of versleep om de volgorde te wijzigen. Kaartjes die je op de Homepage onder "Binnenkort" aanmaakt met doelgroep "Vakgenoten" verschijnen automatisch óók hier — die hoef je hier niet apart toe te voegen.',
  type: 'array',
  of: [
    {
      type: 'object',
