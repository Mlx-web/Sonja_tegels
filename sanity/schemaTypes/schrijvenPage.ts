...
const cardField = defineField({
  ...
  description:
    'Voeg toe, verwijder of versleep om de volgorde te wijzigen. Kaartjes die je op de Homepage onder "Binnenkort" aanmaakt met doelgroep "Schrijven voor Iedereen" verschijnen automatisch óók hier — die hoef je hier niet apart toe te voegen.',
  type: 'array',
  of: [
    {
      type: 'object',
  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({name: 'times', title: 'Tijden', type: 'text', rows: 2}),
        defineField({name: 'location', title: 'Locatie', type: 'text', rows: 2}),
        binnenkortField,
      ],
    }),
    defineField({
